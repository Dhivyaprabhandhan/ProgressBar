...
import {getData, DT_CHANGE_PASSWORD} from '../../../common/data/index';
...
const LoginScreen = props => {
  ...
  const proceedApi = () => {
    // alert("dfsdf")
    let params = {
      oldPassword: formFields.find((e)=> e.uK === formFieldsMeta.old__password.uK).inputVal,
      newPassword: formFields.find((e)=> e.uK === formFieldsMeta.credential__confirm_password.uK).inputVal,
      email: formFields.find((e)=> e.uK === formFieldsMeta.email.uK).inputVal,
      
    };
    getData({
      type :DT_CHANGE_PASSWORD,
      params,
  ...
  return (
    <ScrollView contentContainerStyle={{flexGrow: 1}}>
        ...
        <InputText
          ...
          error = "Confirm Password should be same as New Password"
